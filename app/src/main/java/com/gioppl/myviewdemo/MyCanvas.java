...
public class MyCanvas {
     ...
     * @param points 点集合
     */
    public static void drawCircleLine(Canvas canvas, int value, Paint paint, View view,PointBean pointCircle,ArrayList<PointBean> points) {
    ...
    //贝塞尔画圆8个锚点
    public static void drawCircleLine2(Canvas canvas, int controllerValue, Paint paint, View view,PointBean pointCircle,ArrayList<PointBean> points) {
        Path circleLinePath=new Path();
