...
/**
 * create time：2019/4/17 8:28
 * creater：17664
 * desc:
 */
public class MyPointView extends View {
    private String mButtonStr="GIOPPL";
    ...
    private void openButton() {
        ...
        openAnimSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationCancel(Animator animation) {
                ...
                Log.i("动画2","onAnimationCancel");
            }

            @Override
            public void onAnimationRepeat(Animator animation) {
                super.onAnimationRepeat(animation);
                Log.i("动画2","onAnimationRepeat");
            }

            @Override
            public void onAnimationStart(Animator animation) {
                super.onAnimationStart(animation);
                Log.i("动画2","onAnimationStart");
            }

            @Override
            public void onAnimationPause(Animator animation) {
                super.onAnimationPause(animation);
                Log.i("动画2","onAnimationPause");
            }

            @Override
            public void onAnimationResume(Animator animation) {
                super.onAnimationResume(animation);
                Log.i("动画2","onAnimationResume");
            }

            @Override
            public void onAnimationEnd(Animator animation) {
                isAniming = false;
                Log.i("动画2","onAnimationEnd");
            }
        });
        openAnimSet.start();
    }
